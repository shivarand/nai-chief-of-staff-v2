...
// Get recent conversations for context (increased to 30)
...
// Update today's summary with anti-drift instructions
...
// Get all fact overrides as a single string (most recent last)
...
export async function addOpenLoop(question: string) {
  // Avoid duplicates — only add if a similar open question doesn't already exist
...
// Build memory context string for Claude (updated with 30 messages and open loops)
