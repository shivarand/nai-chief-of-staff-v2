...
1. Planet Furniture (Thailand) Ltd — rubberwood and iron furniture factory exporting to France and Europe. ~98 employees. Carrying debt. Key priorities: cashflow, consistent orders, CNC utilization, hiring CNC overseer and architecture staff. Key contacts: Fon (painting section), LUT (logistics/fuel).

2. MuCat — cat care companion mobile app for Thai cat owners (~70% complete). Also includes cat hotel/condo physical business.

3. Stone sinks / home décor (C9 Furniture) — online marketplace sales. Using FlowAccount for back-office.
